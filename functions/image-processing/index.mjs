...
// sharp library is used to transform images
// sharp library is not included in the Lambda layer, so it needs to be installed in the function itself
...
export const handler = async (event) => {
  ...
  //   creating a sharp object from the original image body
  // sharp library is used to transform images
